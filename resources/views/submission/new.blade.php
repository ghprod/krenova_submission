    ...
    <div class="col-lg-6 col-lg-offset-3 content">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="my_email" name="my_email" placeholder="Email" value="{{session('user')->email}}" disabled>
            </div>
            <div class="form-group">
            ...
            <h3>BIODATA Kreator/Inovator&nbsp;<small><input type="checkbox" class="triggerCreatorValue"> Sama dengan pengirim data</small></h3>
            <hr/>
            <div class="form-group">
